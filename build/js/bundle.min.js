function darkMode(){const e=window.matchMedia("(prefers-color-scheme: dark)");e.matches?document.body.classList.add("modo-oscuro"):document.body.classList.remove("modo-oscuro"),e.addEventListener("change",(function(){e.matches?document.body.classList.add("modo-oscuro"):document.body.classList.remove("modo-oscuro")}));document.querySelector(".dark-mode-buton").addEventListener("click",(function(){document.body.classList.toggle("modo-oscuro")}))}function EventListener(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponsive)}function navegacionResponsive(){const e=document.querySelector(".navegacion");e.classList.contains("mostrar-navegacion")?e.classList.remove("mostrar-navegacion"):e.classList.add("mostrar-navegacion")}
